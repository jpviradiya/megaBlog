...
export default function RTE({ name, label, control, defaultValue = "" }) {
  return (
    <div className="w-full">
      ...
      {/* controller give full control of current component to its parent componenet using porps name 'control' */}
      <Controller
        name={name || 'content'}
        control={control}   // gives ctrl to parent component
        render={({ field: { onChange } }) => (  // field is set to be if any change  is made in this component then it will render
          <Editor
